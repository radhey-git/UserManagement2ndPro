...
public class AppConstants {
	...
	public static final String ACC_LOCKED = "accLock";

	public static final String SUCCESS = "SUCCESS";

	public static final String INVALID_CRD = "inVldCrdntls";
	...
	public static final String EMAIL_BODY_FILE = "emailBody";
	...
	public static final String FORGOT_PAZZWORD_BODY = "frgtPwdBody";

	public static final String CHECK_EMAIL_FOR_PAZZWORD = "checkUrEmailForPassword";

	public static final String FORGOT_PAZZWORD_EMAIL_SUBJECT = "frgtPwdEmailSubject";
